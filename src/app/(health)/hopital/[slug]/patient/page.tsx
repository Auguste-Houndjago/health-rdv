...
import { getPatientAnciennesVisites, getPatientMedecins, getPatientRendezVous } from '@/services/rendezvous/actions';
...
export default async function Page({params}: {params: {slug: string}}) {
  ...
  const [rendezVous, anciennesVisites, medecins] = await Promise.all([
    getPatientRendezVous({patientId: user.id, slug: slug}),
    getPatientAnciennesVisites({patientId: user.id, slug: slug}),
    getPatientMedecins({patientId: user.id, slug: slug}),
  ])
