...
import { GlassInputWrapper, GoogleIcon, Testimonial, TestimonialCard } from "./components";
        ...
        <div className="w-full max-w-md">
          <div className="flex flex-col gap-6">
            ...
            <p className="animate-element animate-delay-900 text-center text-sm text-muted-foreground">
              New to our platform? <a href="#"  className="text-violet-400 hover:underline transition-colors">Create Account</a>
            </p>
          </div>
        </div>
      </section>
